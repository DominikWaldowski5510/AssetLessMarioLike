...
{
	private PlayerBlockTriggering blockTrigger;
	...
	private float gravity = 3;				//the default gravity value
	private float jumpTimer;				//used for allowing early jumps
	[Header("Events")]
	[Space]
	...
	{
		m_JumpForce = 16;
		blockTrigger = this.GetComponent<PlayerBlockTriggering>();
	}
	...
	public void Move(float move, bool jump)
	{
		...
		//lets you have small or big jump based on whenever the button is pressed or held
